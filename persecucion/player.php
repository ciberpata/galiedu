<style>
    .stun-overlay { position: fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.8); display:flex; flex-direction:column; align-items:center; justify-content:center; z-index:200; backdrop-filter: blur(5px); }
    .crash-icon { font-size: 5rem; animation: shake 0.5s; }
...
<div id="screen-play" class="screen">
    <div id="stunLayer" class="stun-overlay" style="display:none;">
        ...
        <h2 style="color:white;">¡HAS CHOCADO!</h2>
        <p>Espera 3 segundos para reincorporarte...</p>
    </div>
...
const GameModule = {
    ...
    checkStatus: function(isBlocked) {
        ...
        document.getElementById('stunLayer').style.display = isBlocked ? 'flex' : 'none';
    },
